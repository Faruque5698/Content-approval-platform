...
@section('content')
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Trashed Post List</h1>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <form action="{{ route('posts.trash') }}" method="GET" class="d-flex gap-2 align-items-center">
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control"
                               placeholder="Search post title">

                        <button type="submit" class="btn btn-primary">Filter</button>
                        <a href="{{ route('posts.trash') }}" class="btn btn-secondary">Reset</a>
                    </form>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        @forelse($posts as $post)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($post->deleted_at)->format('d M, Y') }}</td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">No trashed posts found.</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
